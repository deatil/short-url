...
<head>
    ...
    <!-- Styles -->
    <link href="{{ assets('index/css/css2.css') }}" rel="stylesheet">
    <link href="{{ assets('index/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ assets('index/css/fontawesome-all.min.css') }}" rel="stylesheet">
    <link href="{{ assets('index/css/swiper.css') }}" rel="stylesheet">
...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href=""><img src="{{ assets('index/picture/logo.svg') }}" alt="alternative"></a> 
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ assets('index/picture/header-image.png') }}" alt="alternative">
    ...
    <div id="details" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ assets('index/picture/details-1.png') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ assets('index/picture/details-2.png') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div id="features" class="accordion-1">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ assets('index/picture/features-dashboard.png') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="quotes" src="{{ assets('index/picture/quotes.svg') }}" alt="alternative">
                        <div class="card-body">
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-1.png') }}" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-2.png') }}" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-3.png') }}" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-4.png') }}" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-5.png') }}" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ assets('index/picture/customer-logo-6.png') }}" alt="alternative">
                                </div>
    ...
    <div class="footer bg-gray">
        <img class="decoration-circles" src="{{ assets('index/picture/decoration-circles.png') }}" alt="alternative">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <ul class="list-unstyled li-space-lg p-small">
                        ...
                        <li>
                            @if (!empty($user))
                                <a href="{{ route('my.index') }}">{{ $user['username'] }}</a>
                            @else
                                <a href="{{ route('account.login') }}">登录</a>
                            @endif
                        </li>
                    </ul>
                </div> <!-- end of col -->
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <p class="p-small statement">Copyright &copy; {{ date('Y') }}.Deatil All rights reserved.</a></p>
                </div> <!-- end of col -->
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="{{ assets('index/picture/up-arrow.png') }}" alt="alternative">
    </button>
    <!-- end of back to top button -->
        
    <!-- Scripts -->
    <script src="{{ assets('index/js/bootstrap.min.js') }}"></script> <!-- Bootstrap framework -->
    <script src="{{ assets('index/js/swiper.min.js') }}"></script> <!-- Swiper for image and text sliders -->
    <script src="{{ assets('index/js/scripts.js') }}"></script> <!-- Custom scripts -->
</body>
</html>